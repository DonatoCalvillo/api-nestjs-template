...
import { UserCacheInvalidationHandler } from './infrastructure/events/invalidate-user-cache.handler';
import { LogUserCreatedHandler } from './infrastructure/events/log-user-created.handler';
